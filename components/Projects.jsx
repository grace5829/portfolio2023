...
const Projects = () => {
  return (
    <div id='projects' className='w-full'>
        ...
        <Projectitem title='Pixel Pond' backgroundImg={pixelPondImg} projectUrl='/pixelPond' />
        <Projectitem title="Worm's Eye View" backgroundImg={wormsEyeView} projectUrl='/wormsEyeView' />
        <Projectitem title='FunkoPop Shop' backgroundImg={FunkoPopImg} projectUrl='/funkoPop' />
